...
outliers1_index <- which(r1 == outliers[1] | r1 == outliers[2])
...
outliers_effect_int <- outliers.effects(tipos_outliers2, n = length(manzana_train))
...
prediccion_ets <- forecast(modelo_ets, h = 12)
