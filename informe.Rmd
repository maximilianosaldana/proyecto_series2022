...
p_valores_box_tso <- tibble(
  lag = 1:36, 
  p_valores = sapply(1:36, function(i) Box.test(r3, lag = i, type = "Ljung-Box")$p.value)
  )
...
p_valores_box_clean <- tibble(
  lag = 1:36, 
  p_valores = sapply(1:36, function(i) Box.test(r4, lag = i, type = "Ljung-Box")$p.value)
  )
