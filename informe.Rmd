...
p_valores_box1 <- tibble(
  lag = 1:36, 
  p_valores = sapply(1:36, function(i) Box.test(r1, lag = i, fitdf = 5, type = "Ljung-Box")$p.value)
  )
...
p_valores_box1_int2 <- tibble(
  lag = 1:36, 
  p_valores = sapply(1:36, function(i) Box.test(r1_int2, lag = i, fitdf = 5,type = "Ljung-Box")$p.value)
  )
...
p_valores_box <- tibble(
  lag = 1:36, 
  p_valores = sapply(1:36, function(i) Box.test(r2, lag = i, fitdf = 4, type = "Ljung-Box")$p.value)
  )
...
Los parámetros resultantes de la estimación inicial para el modelo manual son:

* Parte autorregresiva: $\phi_1 = 0.951$ y $\phi_2 = -0.4463$.

* Parte medias móviles: $\theta_1 = -0.4157$.

* Parte autorregresiva estacional: $\Phi_1 = 0.102 $ y $\Phi_2 = 0.397$.
